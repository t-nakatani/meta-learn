...
class DataGenerator(object):
    ...
    def sample_batch(self, batch_type, batch_size):
        ...
        for b in range(B):
            ...
            labels = paths.copy()
            images_labels = get_images(paths, labels, nb_samples=K, shuffle=True) # List of (label, image_path) tuples
            ib3 = []
            lb3 = []
            for k in range(K):
                ib2 = []
        ...
        return np.array(all_image_batches), np.array(all_label_batches)
